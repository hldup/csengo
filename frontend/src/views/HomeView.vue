...
<div>
  <div class="background" :class="{reappear: reapear}">
    <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" viewBox="0 0 60 120">
    ...
    <svg xmlns="http://www.w3.org/2000/svg"  preserveAspectRatio="xMidYMid slice" viewBox="0 0 100 140" >
